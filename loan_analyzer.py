...
# variable to hold future value of loan
...
# variable to hold discount rate
discount_rate = .2
#variable that caluculates present value
...
if fair_value >= loan_price:
    print("Loan is worth the cost to buy.")
#    Else, the present value of the loan is less than the loan cost, then print a message that says that the loan is too expensive and not worth the price.
else: 
    print("Loan is too expensive, not worth it.")
